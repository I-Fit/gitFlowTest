  ...
  <main>
    ...
    <div class="party">
      ...
      <div class="party-top">
        ...
        <p class="text03" @click="likedGroup">찜한 모임 내역</p>
      </div>
...
export default {
  ...
  setup() {
    ...
    const searchGroups = async () => {
      ...
      try {
        const response = await apiClient.get("/joined/search", {
          params: {
    ...
    const selectedGroupList = async () => {
      try {
        const response = await apiClient.get("/joined/sort", {
          params: {
