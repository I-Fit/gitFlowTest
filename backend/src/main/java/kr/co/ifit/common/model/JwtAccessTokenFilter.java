...
public class JwtAccessTokenFilter extends OncePerRequestFilter {
    ...
    protected void doFilterInternal(HttpServletRequest request, HttpServletResponse response, FilterChain filterChain)
        ...
        if (uri.startsWith("/api/create-group")
                ...
                || uri.startsWith("/api/board/new") || uri.startsWith("/api/board/posts/by") || uri.startsWith("/api/board/update")
                || uri.startsWith("/api/board/delete") || uri.startsWith("/api/board/like") || uri.startsWith("/api/board/posts/liked")
                || uri.startsWith("/api/board/post/") || uri.startsWith("/api/comments/new")
                || uri.startsWith("/api/comments/by") || uri.startsWith("/api/comments/delete") || uri.startsWith("/posts/liked/sort")
                ...
                || uri.startsWith("/api/user/password/change")
        ) {
